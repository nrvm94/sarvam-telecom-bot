        ...
        try:
            ...
            if lang == "hi":
                system_prompt = (
                    ...
                    "HIGHEST PRIORITY RULE: यदि customer का सवाल Airtel telecom services से बिल्कुल भी related नहीं है — "
                    "जैसे general knowledge, दूसरे brands, entertainment, gibberish, या कोई भी non-Airtel topic — "
                    "तो बिना किसी exception के सिर्फ यही कहें: "
                    "'मैं सिर्फ Airtel से जुड़े सवालों में आपकी मदद कर सकती हूँ। "
                    "क्या आपका कोई Airtel से related सवाल है, या हम call यहीं समाप्त करें?' "
                ...
                system_prompt = (
                    ...
                    "HIGHEST PRIORITY RULE: जर customer चा प्रश्न Airtel telecom services शी अजिबात संबंधित नसेल — "
                    "जसे general knowledge, इतर brands, entertainment, gibberish, किंवा कोणताही non-Airtel विषय — "
                    "तर कोणताही अपवाद न करता फक्त हेच म्हणा: "
                    "'मी फक्त Airtel संबंधित प्रश्नांमध्ये तुमची मदत करू शकते. "
                    "तुमचा Airtel संबंधित काही प्रश्न आहे का, किंवा आपण call इथेच संपवूया?' "
                ...
                system_prompt = (
                    "STRICT: Output ONLY the final customer response — no reasoning steps, no numbered analysis, "
                    "no chain-of-thought. Start directly with the first word of your answer. "
                    "HIGHEST PRIORITY RULE: If the customer's question is not related to Airtel telecom services — "
                    "including general knowledge, other brands, entertainment, gibberish, or any non-Airtel topic — "
                    "respond with ONLY this, without exception: "
                    "'I can only help you with Airtel related questions. "
                    "Do you have any Airtel question, or shall we end the call?' "
