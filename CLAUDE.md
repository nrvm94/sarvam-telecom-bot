...
- **To opt in:** send any WhatsApp message from `919827952804` to the 360dialog sandbox number (visible in the 360dialog dashboard). Must be re-done if the sandbox session expires.
